...
<body>
    ...
    <section class="d-flex flex-column w-100">
        ...
        <div id="content-header">
            <div class="row col-12">
                <div class="col-12 col-sm-7 col-md-6">
                    <img class="img-fluid col-12 h-100" src="templates/images/produto_persianas.jpg" alt="">
                </div>

                <div class="col-12 col-sm-5 col-md-6">
                    <h3 class="mx-2 mb-4 mt-4 mt-md-0">Persianas </h3>
                    <p>
                        A persiana é uma opção repleta de vantagens para qualquer ambiente. A Domvirê, 
                        líder de mercado e atenta às tendências mais recentes, oferece produtos inovadores que 
                        proporcionam uma infinidade de possibilidades. 

                        Além de sua função decorativa, essas cortinas também visam controlar o ruído e garantir 
                        privacidade.
                    </p>
        ...
        <div id="more-products">
            <div class="container-fluid container-lg more-products-container">
                ...
                <div class="row col-12 d-flex justify-content-center px-2 mt-4 mb-4">
                    <!-- Div - Papel de Parede -->
                    <div class="col-10 col-md-5 col-lg-5 mb-2 mx-1 mx-lg-2 py-2 d-flex align-items-end shadow" id="wallpaper">

                        <div class="w-100 col-md-6 d-flex justify-content-between products-content">
                            <span class="col-8 text-end text-light">Papeis de Parede </span>
                            <button class="btn btn-lg btn-primary col-3 shadow rounded-0" id="btn-wallpaper"> 
                                <span class="material-symbols-outlined">arrow_forward </span> 
                            </button>
                        </div>
                    </div>

                    <!-- Div - Cortina em Tecido -->
                    <div class="col-10 col-md-5 col-lg-5 mb-2 mx-1 mx-lg-2 py-2 d-flex align-items-end shadow" id="curtain">
                        ...
                        <div class="w-100 d-flex justify-content-between products-content">
                            <span class="col-8 text-end text-light">Cortinas em Tecido</span>
        ...
        <div id="recomendations">
            ...
            <div class="list d-flex flex-row px-3 px-md-4 mb-5">

                <!-- Item 01 - Quarto -->
                <div class="items col-10 col-md-6 col-lg-4 shadow mx-2 rounded" id="item-01">
                ...
                <div class="items col-10 col-md-6 col-lg-4 shadow mx-2 rounded" id="item-02">
                ...
                <!-- Item 02 - Escritório -->
                <div class="items col-10 col-md-6 col-lg-4 shadow mx-2 rounded" id="item-03">
