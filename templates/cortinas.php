...
<head>
    ...
    <title>Produtos - Cortinas em Tecido </title>
        ...
        <div id="content-header">
            <div class="row col-12">
                <div class="col-12 col-sm-7 col-md-6">
                    <img class="img-fluid col-12 h-100" src="templates/images/produto_cortinas.jpg" alt="">
                </div>

                <div class="col-12 col-sm-5 col-md-6">
                    <h3 class="mx-2 mb-4 mt-4 mt-md-0">Cortinas em Tecido</h3>
                    <p>
                        As cortinas não só embelezam o ambiente, mas também desempenham um papel crucial
                         ao filtrar a luz externa, regulando sua intensidade para equilibrar a luminosidade 
                         e a temperatura interna. 

                        No Domvirê, nossas cortinas são cuidadosamente confeccionadas sob medida, 
                        utilizando tecidos selecionados de acordo com as últimas tendências em decoração, 
                        garantindo qualidade excepcional em cada produto que entregamos.
                    </p>
